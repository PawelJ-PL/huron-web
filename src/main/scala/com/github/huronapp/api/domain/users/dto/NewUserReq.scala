...
import com.github.huronapp.api.domain.users.dto.fields.{KeyPair, Nickname, Password}
...
final case class NewUserReq(nickName: Nickname, email: Email, password: Password, language: Option[Language], keyPair: KeyPair)
