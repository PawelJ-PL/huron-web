        ...
        it("should fetch collection data", () => {
            ...
            renderWithPath(
                <SingleCollectionManagementContainer
                    ...
                    deleteCollectionResult={{ status: "NOT_STARTED" }}
                    resetDeleteCollectionResult={jest.fn()}
                    deleteMemberResult={{ status: "NOT_STARTED" }}
                    resetDeleteMemberResult={jest.fn()}
                    resetAddMemberResult={jest.fn()}
                    clearSetPermissionsResult={jest.fn()}
                    t={tFunctionMock}
                />
            )
